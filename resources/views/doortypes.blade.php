...
<body>
    ...
    @if(session('doortype'))
    <div class=" bg-green-800 text-white pl-5">{{session('doortype')}}</div>
    @endif
    <div class="bg-gray-100 flex flex-col items-center min-h-screen pt-5">

    <div class=" bg-white p-8 rounded-2xl  shadow-lg w-full max-w-sm">
    <h2 class="text-2xl text-center text-gray-800 mb-6 ">Add Door Types </h2>
    <form action="/adddoortype" method="post" class="space-y-4">
        @csrf
        <div>
            <input type="text"placeholder="Enter door type" name="doortype"
    ...
    <div class="w-200">
        <h1 class="text-2xl text-blue-500">Door Types</h1>
        ...
        <li class="p-2 font-bold">
            ...
            <li class="even:bg-gray-200 p-2">
                <ul class="flex justify-between">
                    <li class="w-30">{{$doortype->id}}</li>
                    <li class="w-70">{{$doortype->name}}</li>
                    <li class="w-70">{{$doortype->added_by}}</li>
                    <li class="w-30 flex">
                        <a href="doorttype/delete/{{$doortype->id}}">
                        ...
                        <a href="doorttype-list/{{$doortype->id}}/{{$doortype->name}}">
